...
const experiences = [
  {
    ...
    description: "Led comprehensive technical SEO audits, keyword research, competitive analysis, and strategy execution. Focused on Core Web Vitals optimization, structured data implementation, and E-E-A-T signal enhancements.",
