    ...
    if (ownDomain === "rejishkhanal.com.np") {
      return NextResponse.json({
        ...
        result: {
          ...
          onPage: {
            title: "Rejish Khanal - Technical SEO Expert & Full Stack Developer",
            titleLength: 60,
            metaDescription: "Technical SEO Expert and Full Stack Developer based in Kathmandu, Nepal.",
            ...
            h2Count: 6,
            h3Count: 4,
            ogTitle: "Rejish Khanal - Technical SEO Expert",
            ogDescription: "Technical SEO Expert and Full Stack Developer based in Kathmandu, Nepal.",
